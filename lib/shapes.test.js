...
// test that the output of shape getText reflects what was input
    it('should reflect what was input', () => {
        const expectedString = `<text text-anchor="middle" font-size="2em" x="150" y="100" font-family="monospace" fill="blue">TTT</text>`;

        const myShape = new Shape("TTT", "blue", "green");
        const actualString = myShape.getText();
